...
class SMSManager:
    ...
    def __new__(cls, service_name: str, user_mobile: str, **kwargs: Any):
        """
        ...
        Returns:
            An instance of the specified SMS service.
        ...
        if not service_class:
            raise ValueError(f"Invalid service name: {service_name}, available services: {list(cls.services.keys())}")
